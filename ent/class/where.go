...
func ClassID(v uuid.UUID) predicate.Class {
	return predicate.Class(func(s *sql.Selector) {
...
func ClassIDEQ(v uuid.UUID) predicate.Class {
	return predicate.Class(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldClassID), v))
	})
}
...
func ClassIDNEQ(v uuid.UUID) predicate.Class {
	return predicate.Class(func(s *sql.Selector) {
...
func ClassIDIn(vs ...uuid.UUID) predicate.Class {
...
func ClassIDNotIn(vs ...uuid.UUID) predicate.Class {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ClassIDGT(v uuid.UUID) predicate.Class {
	return predicate.Class(func(s *sql.Selector) {
...
func ClassIDGTE(v uuid.UUID) predicate.Class {
	return predicate.Class(func(s *sql.Selector) {
...
func ClassIDLT(v uuid.UUID) predicate.Class {
	return predicate.Class(func(s *sql.Selector) {
...
func ClassIDLTE(v uuid.UUID) predicate.Class {
	return predicate.Class(func(s *sql.Selector) {
